      ...
      <Container as="main" className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-3xl">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-[#a855f7]/20 bg-[#a855f7]/10 px-3 py-1">
            ...
            <span className="text-xs font-mono tracking-widest text-[#c084fc]">05 — CONTACT</span>
          </div>
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/60">
            Have a question, idea, or want to collaborate? I&apos;d like to hear from you.
          </p>
          <div className="mt-6 h-px w-full bg-gradient-to-r from-[#a855f7]/30 via-[#a855f7]/10 to-transparent" aria-hidden="true" />
        </div>
        <div className="mx-auto mt-12 max-w-xl rounded-2xl border border-border/60 bg-background/60 p-6 shadow-lg shadow-black/20 sm:p-8">
          <ContactForm />
        </div>
      </Container>
    </div>
