...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="group flex h-full flex-col rounded-2xl border border-border/60 bg-background/60 p-6 shadow-lg shadow-black/20 transition-colors duration-300 hover:border-foreground/20">
      {project.image && (
